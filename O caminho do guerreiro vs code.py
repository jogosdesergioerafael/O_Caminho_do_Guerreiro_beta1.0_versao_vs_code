...
# Desenho do Guerreiro no título e desenho da Igreja de Saquarema dos créditos

def desenho_inicial_creditos_rpg(texto):
  for letra in texto:
    sys.stdout.write(letra)
    sys.stdout.flush()
    time.sleep(0.003)
...
# Condicionais do menu principal


while menu_principal not in '1,2,3':
        texto = ('\n\033[1;31;41mOpção inválida!\033[m\n')
        escrita_rpg(texto)
        texto = ('\033[1;31;41mDigite apenas uma das opções do menu principal.\nNúmero 1 número 2 ou número 3.\033[m')
        escrita_rpg(texto)
        print('\n')
        print('='*69)
        print('\n')
...
-########++-----.--+----..--+#-....-+#++++++---+-+++++++++++++++++++++++-#++##.##+#+###-#-+##+-##-#--+#--#######++######+++#####+##+++++++++++++++++++++++#++++.
  ...
  texto = ('\n\033[1;31mNão tente bugar o jogo apertando a tecla enter\nsem escolher uma das opções do menu principal.\n\033[m')
  escrita_rpg(texto)
  texto = ('\033[1;31;41mRode o código do jogo novamente.\033\n[m')
  escrita_rpg(texto)
  time.sleep(8)
  sys.exit()
...
desenho_inicial_creditos_rpg(texto)
print('\n')
print('='*182)
time.sleep(2)
...
escrita_rpg(texto)
texto = ('Quatro guardiões elementais foram recrutados por Sephiroth para tomar conta dos fragmentos elementais roubados por ele:\n')
escrita_rpg(texto)
...
while escolha not in '1,2':
        texto = ('\n\033[1;31;41mOpção inválida!\033[m\n')
        escrita_rpg(texto)
        texto = ('\033[1;31;41mDigite apenas número 1 ou número 2 para continuar o jogo.\033[m')
        escrita_rpg(texto)
        print('\n')
        print('='*182)
        print('\n')
...
if escolha == '1':
  ...
  texto = ('\n\033[1;31mNão tente bugar o jogo apertando a tecla enter\nsem escolher uma das opções disponíveis.\n\033[m')
  escrita_rpg(texto)
  texto = ('\033[1;31;41mRode o código do jogo novamente.\033\n[m')
  escrita_rpg(texto)
  time.sleep(8)
...
if escolha == '1':
    ...
    escrita_rpg(texto)
    texto = (f'{personagem} e pé de pano caíram do alto da montanha e se arrebentaram no chão causando dano crítico.\n')
    escrita_rpg(texto)
    texto = ('\nFim de jogo.\n\n')
    escrita_rpg(texto)
    time.sleep(13)
...
escrita_rpg(texto)
texto = ('Devido ao pouco tempo entre família, trabalho e faculdade, conseguimos concluir apenas 3 capítulos da história.\n')
escrita_rpg(texto)
...
escrita_rpg(texto)
texto = ('Agradecemos pelos ensinamentos do professor João Coelho que estão sendo ministrados na turma B da Universidade de Vassouras de Saquarema.\n')
escrita_rpg(texto)
